...
// // Obtains the interpolated HTML contents of a `PUT` request from
// // the main client code and crafts an HTML response for the
// // interpolated result.
...
//     return self.caches.open('render-store').then(function (cache) {
//       // Associate the crafted response with the `referrer` property of the
//       // request which is the URL of the client page initiating the request.
